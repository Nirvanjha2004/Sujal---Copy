...
import { getS3ImageUrl, getS3BaseUrl } from "@/shared/utils/s3ImageUtils";
import {
  Select,
  SelectTrigger,
  SelectValue,
...
export function RealEstateLandingPage() {
  ...
  // Get CDN URL for preloading
  const cdnUrl = getS3BaseUrl();

  // Prepare critical images for preloading (hero + first 4 featured projects)
  const criticalImages = [
    getS3ImageUrl("images/topbanner.png"), // Hero image
    ...featuredProjects.slice(0, 4).map(project => project.image), // First 4 featured projects
  ];

  // Prepare prefetch images (hover prefetch for remaining projects)
  const prefetchImages = featuredProjects.slice(4).map(project => project.image);

  // Hover prefetch handler for project cards
  const handleProjectHover = (projectImage: string) => {
  ...
  return (
    <>
      {/* Preload critical images and setup CDN connection */}
      <ImagePreloadHead
        cdnUrl={cdnUrl}
      ...
      <div className="min-h-screen bg-background">
                    ...
                    >
                      <CardContent className="p-0">
                        <div className="relative w-full aspect-square overflow-hidden rounded-t-xl">
                          <OptimizedImage
                            images={{
                              image_url: propertyImages[propertyType.value] || getS3ImageUrl("images/1.png"),
                              medium_url: propertyImages[propertyType.value] || getS3ImageUrl("images/1.png"),
                            }}
        ...
        <section className="py-0 full-width-element">
          <div className="w-full">
            <OptimizedImage
              images={{
                image_url: getS3ImageUrl("images/redBanner.png"),
                large_url: getS3ImageUrl("images/redBanner.png"),
              }}
              alt="Featured Banner"
              context="detail"
              priority={false}
                          ...
                          <div className="w-full h-48 rounded-t-xl overflow-hidden">
                            <OptimizedImage
                              images={property.images?.[0] || {
                                image_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/4.webp",
                                medium_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/4.webp"
                              }}
                              alt={property.title}
                              context="grid"
                              priority={false}
                      ...
                      >
                        <CardContent className="p-0">
                          <div className="w-full h-48 rounded-t-xl overflow-hidden">
                            <OptimizedImage
                              images={{
                                image_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/2.webp",
                                medium_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/2.webp"
                              }}
                              alt="IBL NANDAN ROAD Project"
                              context="grid"
                              priority={false}
                              className="w-full h-full"
                              showBlurPlaceholder={true}
                      ...
                      >
                        <CardContent className="p-0">
                          <div className="w-full h-48 rounded-t-xl overflow-hidden">
                            <OptimizedImage
                              images={{
                                image_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/5.webp",
                                medium_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/5.webp"
                              }}
                              alt="BIRLA MANDIR Project"
                              context="grid"
                              priority={false}
                              className="w-full h-full"
                              showBlurPlaceholder={true}
                      ...
                      >
                        <CardContent className="p-0">
                          <div className="w-full h-48 rounded-t-xl overflow-hidden">
                            <OptimizedImage
                              images={{
                                image_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/1.webp",
                                medium_url: "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/landscape/1.webp"
                              }}
                              alt="IBC, FERN ROAD Project"
                              context="grid"
                              priority={false}
                              className="w-full h-full"
                              showBlurPlaceholder={true}
                        ...
                        >
                          <CardContent className="p-0">
                            <div className="w-full h-32 rounded-t-xl overflow-hidden">
                              <OptimizedImage
                                images={{
                                  image_url: project.images?.[0] || "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/square/1.webp",
                                  thumbnail_url: project.images?.[0] || "https://wqnmyfkavrotpmupbtou.supabase.co/storage/v1/object/public/generation-assets/photos/residential-listings/square/1.webp"
                                }}
                                alt={project.name}
                                context="thumbnail"
                                priority={false}
