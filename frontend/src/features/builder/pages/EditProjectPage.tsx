  ...
  useEffect(() => {
    const fetchProject = async () => {
      ...
      try {
        ...
        setValue('pincode', project.pincode);
        setValue('projectType', project.project_type);
        ...
        if (project.expected_completion) {
          const completionDate = new Date(project.expected_completion).toISOString().split('T')[0];
          setValue('expectedCompletion', completionDate);
        }
        
        setValue('reraNumber', project.rera_number || '');
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => navigate(`/builder/projects/${id}`)}
          >
