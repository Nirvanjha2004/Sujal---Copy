...
import { ImageUrls } from "@/shared/utils/imageUtils";
...
export function PropertyCard({ 
  ...
  const getImageUrls = (): ImageUrls => {
    ...
    if (!imageData) {
      ...
      const placeholderUrl = "https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80";
      return {
        image_url: placeholderUrl,
        thumbnail_url: placeholderUrl,
        medium_url: placeholderUrl,
        large_url: placeholderUrl,
      };
    }
    
    // Return the image URLs in the format expected by OptimizedImage
    return {
      image_url: imageData.image_url,
      thumbnail_url: imageData.thumbnail_url,
      medium_url: imageData.medium_url,
      large_url: imageData.large_url,
      thumbnail_webp_url: imageData.thumbnail_webp_url,
      medium_webp_url: imageData.medium_webp_url,
      large_webp_url: imageData.large_webp_url,
    };
  };
