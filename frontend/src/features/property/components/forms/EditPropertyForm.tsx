...
import { Loader2, Plus, X, MapPin, Upload, Save, Trash2 } from 'lucide-react';
...
export const EditPropertyForm: React.FC<EditPropertyFormProps> = ({
  ...
  // Load initial property data if provided
  useEffect(() => {
    if (initialProperty) {
      ...
      <div className="space-y-6">
        ...
        {Object.keys(errors).length > 0 && (
          <Alert variant="destructive">
            <AlertDescription>
              Please fix the errors above before saving changes.
            </AlertDescription>
          </Alert>
        )}
        ...
        {showDeleteConfirm && (
          <Alert variant="destructive">
            <AlertDescription className="flex items-center justify-between">
              <span>Are you sure you want to delete this property? This action cannot be undone.</span>
