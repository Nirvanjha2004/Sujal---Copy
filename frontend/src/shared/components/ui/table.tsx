...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-lg border border-border/50 bg-card/50 backdrop-blur-sm shadow-sm">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead 
    ...
    className={cn(
      ...
      "[&_tr:first-child]:rounded-t-lg overflow-hidden",
      className
    )} 
    {...props} 
  />
